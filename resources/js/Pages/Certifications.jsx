...
export default function Certifications({ profile, all_certifications }) {
    ...
    return (
        <>
            ...
            <meta
                name="description"
                content={`Verified professional developer certifications of ${profile.name}.`}
            />
                                ...
                                >
                                    <h3
                                        className={[
                                            ...
                                            "leading-tight",
                                            "display-font",
                                            "group-hover/cert:text-indigo-500",
                                            "transition-colors",
                                        ].join(" ")}
                                    >
                                        {cert.title}
