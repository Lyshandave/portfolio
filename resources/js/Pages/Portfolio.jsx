...
function Chatbot() {
    ...
    const getBotResponse = async (message) => {
        ...
        try {
            const searchRes = await fetch(
                `https://en.wikipedia.org/w/api.php?action=query&list=search&srsearch=${encodeURIComponent(message)}&utf8=&format=json&origin=*`,
            );
    ...
    const mobileChatHeight = mobileViewportHeight
        ? Math.max(280, mobileViewportHeight - 24)
        : undefined;
            ...
            <div
                ...
                style={{
                    height: mobileChatHeight
                        ? `min(${mobileChatHeight}px, calc(100dvh - 1.5rem))`
                        : undefined,
                }}
            >
                <div
                ...
                >
                    ...
                    >
                        <i
                            className={["fas", "fa-times", "text-lg"].join(" ")}
                        ></i>
                    </button>
                </div>
                    ...
                    {messages.map((msg, index) => (
                        ...
                        >
                            ...
                            <div
                                className={[
                                    msg.sender === "user"
                                        ? "bg-slate-800 text-white p-3 rounded-lg text-[14px] max-w-[90%] leading-relaxed inline-block"
                                        : "bg-[#f0f0f0] p-4 rounded-lg text-[14px] text-slate-800 max-w-[90%] leading-relaxed inline-block",
                                ].join(" ")}
                            >
                                {msg.text}
                            </div>
...
export default function Portfolio(props) {
    ...
    const maxGalleryIndex = Math.max(
        0,
        galleryImages.length - galleryVisibleCount,
    );
    ...
    useEffect(() => {
        ...
        return () =>
            window.removeEventListener("resize", updateGalleryVisibleCount);
    }, []);
    ...
    useEffect(() => {
        ...
        async function syncPortfolio() {
            try {
                const etag =
                    document
                        .querySelector('meta[name="x-portfolio-etag"]')
                        ?.getAttribute("content") ||
    ...
    return (
        <>
            ...
            <meta
                name="description"
                content={`Portfolio of ${profile.name}, a certified Computer Systems Technician and Web Developer.`}
            />
            <meta
                name="keywords"
                content="Lyshan Dave, Computer Systems Technician, Web Developer, IT Support, Networking"
            />
            ...
            <meta
                property="og:image"
                content="https://lyshandave.com/lyshandave.png"
            />
            ...
            >
                ...
                >
                    ...
                    >
                        <div className={["relative", "shrink-0"].join(" ")}>
                            <img
                                alt={profile.name}
                                fetchPriority="high"
                                width="160"
                                        ...
                                        return (
                                            <a
                                                ...
                                                className={[
                                                    ...
                                                    "border-b-2",
                                                    "border-b-slate-300",
                                                    "dark:border-b-slate-900/80",
                                                    "shadow-[0_3px_6px_rgba(0,0,0,0.05)]",
                                                    "hover:shadow-[0_5px_10px_rgba(0,0,0,0.08)]",
                                                    "transition-all",
                                                    "duration-100",
                                                    "transform",
                                                    "hover:-translate-y-0.5",
                ...
                >
                    ...
                    >
                        ...
                        <div
                            ...
                            className={["relative", "space-y-3", "mt-2.5"].join(
                                " ",
                            )}
                        >
                            <div
                    ...
                    >
                        ...
                        <div
                            ...
                            className={["space-y-3", "mt-4"].join(" ")}
                        >
                            {certifications.map((cert, i) => (
                                <button
                                    key={i}
                                    onClick={() =>
                                        setSelectedCert(cert.credential_url)
                                    }
                                    className={[
                                        "w-full",
                                        "text-left",
                            ...
                            >
                                ...
                                >
                                    ...
                                    <a
                                        ...
                                        href="mailto:lyshandavet@gmail.com"
                                    >
                    ...
                    >
                        ...
                        >
                            <div
                                ...
                                style={{
                                    transform: `translateX(-${galleryIndex * gallerySlidePercent}%)`,
                                    width: "100%",
                                }}
                            >
                            ...
                            {canShowNextGalleryImage && (
                                <button
                                    onClick={() =>
                                        setGalleryIndex((prev) =>
                                            Math.min(maxGalleryIndex, prev + 1),
                                        )
                                    }
                                    className={[
                                        "absolute",
            ...
            {lightboxIndex !== null && (
                ...
                >
                    ...
                    >
                        ...
                        >
                            {t.highlight} {lightboxIndex + 1} {t.of}{" "}
                            {galleryImages.length}
                        </p>
                    </div>
                </div>
