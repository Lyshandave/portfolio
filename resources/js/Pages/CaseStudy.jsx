        ...
        <>
            ...
            <div id="app-container" className="max-w-5xl mx-auto px-4 pt-8 pb-4 relative z-10 flex flex-col min-h-screen">
                ...
                <header className="mb-8 flex flex-col items-start">
                    <Link href="/projects" prefetch={['mount', 'hover']} className="inline-flex items-center gap-1.5 text-xs text-slate-500 hover:text-indigo-500 font-semibold transition-colors cursor-pointer" aria-label="Back to projects">
